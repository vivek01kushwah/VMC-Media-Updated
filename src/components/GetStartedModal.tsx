            ...
            <div className="space-y-2.5">
              ...
              <div className="floating-label-container">
                <input
                  ...
                  placeholder=" "
                  required
                  className="floating-input w-full h-10 px-3 text-sm border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all"
                />
              ...
              <div className="floating-label-container">
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="floating-select w-full h-10 px-3 pr-8 text-sm border border-gray-300 rounded-lg bg-white text-gray-900 appearance-none focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all cursor-pointer"
                >
              ...
              <div className="floating-label-container">
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder=" "
                  className="floating-textarea w-full px-3 py-2 text-sm border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all resize-none"
                />
              ...
              <button
                ...
                className="w-full h-10 rounded-lg bg-gradient-to-r from-purple-600 to-purple-700 text-white text-sm font-semibold shadow-lg shadow-purple-500/30 hover:shadow-xl hover:shadow-purple-500/40 hover:scale-[1.01] active:scale-[0.99] transition-all duration-200"
              >
                Request Audit
              </button>
