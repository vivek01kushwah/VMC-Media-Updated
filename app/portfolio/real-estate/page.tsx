    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1">
        ...
        <section className="py-12 bg-muted/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-bold text-foreground mb-12">Featured Real Estate Projects</h2>
        ...
        <section className="py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-bold text-foreground mb-12">Why Choose Our Real Estate Marketing</h2>
