...
<section className="pt-32 pb-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <h2>6. Cookies</h2>
            <p>We use cookies and similar tracking technologies to collect and track information and to improve and analyze our services.</p>
            
            <h2>7. Changes to This Policy</h2>
            <p>We may update this privacy policy from time to time. We will notify you of any changes by posting the new policy on this page.</p>
            
            <h2>Contact Us</h2>
            <p>If you have questions about this Privacy Policy, please contact us at privacy@vmcmedia.com</p>
<Header />
</div>
        </div>
      </section>
